...
const EditProfile = () => {
    ...
    const [input, setInput] = useState({
        ...
        bio: user?.bio,
        gender: user?.gender,
        previewUrl: user?.profilePicture // preview initially current profile
    });
    ...
    const editProfileHandler = async () => {
        ...
        try {
            setLoading(true);
            const res = await axios.post('https://socialbutterfly.onrender.com/api/v1/user/profile/edit', formData,{
                headers:{
            ...
            <section className='flex flex-col gap-6 w-full my-8'>
                ...
                <div className='flex items-center justify-between bg-gray-100 rounded-xl p-4'>
                    <div className='flex items-center gap-3'>
                        <Avatar>
                            <AvatarImage src={input.previewUrl} alt="profile_photo" />
